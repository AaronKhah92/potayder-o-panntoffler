...
var app = (function () {
    ...
    const file$k = "src\\pages\\markers\\citiesin\\skane\\Loderup.svelte";
    ...
    function create_fragment$q(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "data-src", "../images/marker-small.png");
    			attr_dev(img0, "uk-img", "");
    			add_location(img0, file$k, 32, 4, 664);
    			attr_dev(a0, "href", "#modal-youngwoman-loderup");
    			attr_dev(a0, "uk-toggle", "");
    			add_location(a0, file$k, 31, 2, 612);
    			...
    			attr_dev(img1, "data-src", "../images/marker-small.png");
    			attr_dev(img1, "uk-img", "");
    			add_location(img1, file$k, 42, 4, 902);
    			attr_dev(a1, "href", "#modal-youngman-loderup");
    			attr_dev(a1, "uk-toggle", "");
    			add_location(a1, file$k, 41, 2, 852);
    			attr_dev(div0, "id", "young-loderup");
    			add_location(div0, file$k, 30, 0, 584);
    			...
    			attr_dev(img2, "data-src", "../images/marker-small.png");
    			attr_dev(img2, "uk-img", "");
    			add_location(img2, file$k, 54, 4, 1171);
    			attr_dev(a2, "href", "#modal-oldwoman-loderup");
    			attr_dev(a2, "uk-toggle", "");
    			add_location(a2, file$k, 53, 2, 1121);
    			...
    			attr_dev(img3, "data-src", "../images/marker-small.png");
    			attr_dev(img3, "uk-img", "");
    			add_location(img3, file$k, 64, 4, 1405);
    			attr_dev(a3, "href", "#modal-oldman-loderup");
    			attr_dev(a3, "uk-toggle", "");
    			add_location(a3, file$k, 63, 2, 1357);
    			attr_dev(div1, "id", "old-loderup");
    			add_location(div1, file$k, 52, 0, 1095);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Loderup extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$q, create_fragment$q, safe_not_equal, { cityName: 0 });
    ...
    const file$l = "src\\pages\\markers\\citiesin\\skane\\Norrarorom.svelte";
    ...
    function create_fragment$r(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "data-src", "../images/marker-small.png");
    			attr_dev(img0, "uk-img", "");
    			add_location(img0, file$l, 32, 4, 694);
    			attr_dev(a0, "href", "#modal-youngwoman-norrarorom");
    			attr_dev(a0, "uk-toggle", "");
    			add_location(a0, file$l, 31, 2, 639);
    			...
    			attr_dev(img1, "data-src", "../images/marker-small.png");
    			attr_dev(img1, "uk-img", "");
    			add_location(img1, file$l, 42, 4, 944);
    			attr_dev(a1, "href", "#modal-youngman-norrarorom");
    			attr_dev(a1, "uk-toggle", "");
    			add_location(a1, file$l, 41, 2, 891);
    			attr_dev(div0, "id", "young-norrarorom");
    			add_location(div0, file$l, 30, 0, 608);
    			...
    			attr_dev(img2, "data-src", "../images/marker-small.png");
    			attr_dev(img2, "uk-img", "");
    			add_location(img2, file$l, 54, 4, 1228);
    			attr_dev(a2, "href", "#modal-oldwoman-norrarorom");
    			attr_dev(a2, "uk-toggle", "");
    			add_location(a2, file$l, 53, 2, 1175);
    			...
    			attr_dev(img3, "data-src", "../images/marker-small.png");
    			attr_dev(img3, "uk-img", "");
    			add_location(img3, file$l, 64, 4, 1474);
    			attr_dev(a3, "href", "#modal-oldman-norrarorom");
    			attr_dev(a3, "uk-toggle", "");
    			add_location(a3, file$l, 63, 2, 1423);
    			attr_dev(div1, "id", "old-norrarorom");
    			add_location(div1, file$l, 52, 0, 1146);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$m = "src\\pages\\markers\\citiesin\\skane\\Osssjo.svelte";
    ...
    function create_fragment$s(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "data-src", "../images/marker-small.png");
    			attr_dev(img0, "uk-img", "");
    			add_location(img0, file$m, 32, 4, 654);
    			attr_dev(a0, "href", "#modal-youngwoman-osssjo");
    			attr_dev(a0, "uk-toggle", "");
    			add_location(a0, file$m, 31, 2, 603);
    			...
    			attr_dev(img1, "data-src", "../images/marker-small.png");
    			attr_dev(img1, "uk-img", "");
    			add_location(img1, file$m, 42, 4, 888);
    			attr_dev(a1, "href", "#modal-youngman-osssjo");
    			attr_dev(a1, "uk-toggle", "");
    			add_location(a1, file$m, 41, 2, 839);
    			attr_dev(div0, "id", "young-osssjo");
    			add_location(div0, file$m, 30, 0, 576);
    			...
    			attr_dev(img2, "data-src", "../images/marker-small.png");
    			attr_dev(img2, "uk-img", "");
    			add_location(img2, file$m, 54, 4, 1152);
    			attr_dev(a2, "href", "#modal-oldwoman-osssjo");
    			attr_dev(a2, "uk-toggle", "");
    			add_location(a2, file$m, 53, 2, 1103);
    			...
    			attr_dev(img3, "data-src", "../images/marker-small.png");
    			attr_dev(img3, "uk-img", "");
    			add_location(img3, file$m, 64, 4, 1382);
    			attr_dev(a3, "href", "#modal-oldman-osssjo");
    			attr_dev(a3, "uk-toggle", "");
    			add_location(a3, file$m, 63, 2, 1335);
    			attr_dev(div1, "id", "old-osssjo");
    			add_location(div1, file$m, 52, 0, 1078);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$n = "src\\pages\\markers\\citiesin\\stockholm\\Lanna.svelte";
    ...
    function create_fragment$t(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "data-src", "../images/marker-small.png");
    			attr_dev(img0, "uk-img", "");
    			add_location(img0, file$n, 30, 4, 640);
    			attr_dev(a0, "href", "#modal-youngwoman-lanna");
    			attr_dev(a0, "uk-toggle", "");
    			add_location(a0, file$n, 29, 2, 590);
    			...
    			attr_dev(img1, "data-src", "../images/marker-small.png");
    			attr_dev(img1, "uk-img", "");
    			add_location(img1, file$n, 40, 4, 870);
    			attr_dev(a1, "href", "#modal-youngman-lanna");
    			attr_dev(a1, "uk-toggle", "");
    			add_location(a1, file$n, 39, 2, 822);
    			attr_dev(div0, "id", "young-lanna");
    			add_location(div0, file$n, 28, 0, 564);
    			...
    			attr_dev(img2, "data-src", "../images/marker-small.png");
    			attr_dev(img2, "uk-img", "");
    			add_location(img2, file$n, 52, 4, 1129);
    			attr_dev(a2, "href", "#modal-oldwoman-lanna");
    			attr_dev(a2, "uk-toggle", "");
    			add_location(a2, file$n, 51, 2, 1081);
    			...
    			attr_dev(img3, "data-src", "../images/marker-small.png");
    			attr_dev(img3, "uk-img", "");
    			add_location(img3, file$n, 62, 4, 1355);
    			attr_dev(a3, "href", "#modal-oldman-lanna");
    			attr_dev(a3, "uk-toggle", "");
    			add_location(a3, file$n, 61, 2, 1309);
    			attr_dev(div1, "id", "old-lanna");
    			add_location(div1, file$n, 50, 0, 1057);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$o = "src\\pages\\markers\\citiesin\\stockholm\\Sorunda.svelte";
    ...
    function create_fragment$u(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "data-src", "../images/marker-small.png");
    			attr_dev(img0, "uk-img", "");
    			add_location(img0, file$o, 30, 4, 660);
    			attr_dev(a0, "href", "#modal-youngwoman-sorunda");
    			attr_dev(a0, "uk-toggle", "");
    			add_location(a0, file$o, 29, 2, 608);
    			...
    			attr_dev(img1, "data-src", "../images/marker-small.png");
    			attr_dev(img1, "uk-img", "");
    			add_location(img1, file$o, 40, 4, 898);
    			attr_dev(a1, "href", "#modal-youngman-sorunda");
    			attr_dev(a1, "uk-toggle", "");
    			add_location(a1, file$o, 39, 2, 848);
    			attr_dev(div0, "id", "young-sorunda");
    			add_location(div0, file$o, 28, 0, 580);
    			...
    			attr_dev(img2, "data-src", "../images/marker-small.png");
    			attr_dev(img2, "uk-img", "");
    			add_location(img2, file$o, 52, 4, 1167);
    			attr_dev(a2, "href", "#modal-oldwoman-sorunda");
    			attr_dev(a2, "uk-toggle", "");
    			add_location(a2, file$o, 51, 2, 1117);
    			...
    			attr_dev(img3, "data-src", "../images/marker-small.png");
    			attr_dev(img3, "uk-img", "");
    			add_location(img3, file$o, 62, 4, 1401);
    			attr_dev(a3, "href", "#modal-oldman-sorunda");
    			attr_dev(a3, "uk-toggle", "");
    			add_location(a3, file$o, 61, 2, 1353);
    			attr_dev(div1, "id", "old-sorunda");
    			add_location(div1, file$o, 50, 0, 1091);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$p = "src\\pages\\markers\\citiesin\\stockholm\\Vvingaker.svelte";
    ...
    function create_fragment$v(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "data-src", "../images/marker-small.png");
    			attr_dev(img0, "uk-img", "");
    			add_location(img0, file$p, 30, 4, 670);
    			attr_dev(a0, "href", "#modal-youngwoman-vingaker");
    			attr_dev(a0, "uk-toggle", "");
    			add_location(a0, file$p, 29, 2, 617);
    			...
    			attr_dev(img1, "data-src", "../images/marker-small.png");
    			attr_dev(img1, "uk-img", "");
    			add_location(img1, file$p, 40, 4, 912);
    			attr_dev(a1, "href", "#modal-youngman-vingaker");
    			attr_dev(a1, "uk-toggle", "");
    			add_location(a1, file$p, 39, 2, 861);
    			attr_dev(div0, "id", "young-vingaker");
    			add_location(div0, file$p, 28, 0, 588);
    			...
    			attr_dev(img2, "data-src", "../images/marker-small.png");
    			attr_dev(img2, "uk-img", "");
    			add_location(img2, file$p, 52, 4, 1186);
    			attr_dev(a2, "href", "#modal-oldwoman-vingaker");
    			attr_dev(a2, "uk-toggle", "");
    			add_location(a2, file$p, 51, 2, 1135);
    			...
    			attr_dev(img3, "data-src", "../images/marker-small.png");
    			attr_dev(img3, "uk-img", "");
    			add_location(img3, file$p, 62, 4, 1424);
    			attr_dev(a3, "href", "#modal-oldman-vingaker");
    			attr_dev(a3, "uk-toggle", "");
    			add_location(a3, file$p, 61, 2, 1375);
    			attr_dev(div1, "id", "old-vingaker");
    			add_location(div1, file$p, 50, 0, 1108);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$q = "src\\pages\\skane.svelte";
    ...
    function create_fragment$C(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file$q, 83, 8, 2055);
    			attr_dev(li0, "class", "uk-parent svelte-35bq4m");
    			add_location(li0, file$q, 82, 6, 2023);
    			attr_dev(a1, "href", a1_href_value = /*$url*/ ctx[0]("/skane"));
    			attr_dev(a1, "class", "svelte-35bq4m");
    			add_location(a1, file$q, 86, 8, 2141);
    			attr_dev(li1, "class", "uk-parent svelte-35bq4m");
    			add_location(li1, file$q, 85, 6, 2109);
    			attr_dev(a2, "href", a2_href_value = /*$url*/ ctx[0]("/blekinge"));
    			attr_dev(a2, "class", "svelte-35bq4m");
    			add_location(a2, file$q, 89, 8, 2228);
    			attr_dev(li2, "class", "uk-parent svelte-35bq4m");
    			add_location(li2, file$q, 88, 6, 2196);
    			attr_dev(a3, "href", a3_href_value = /*$url*/ ctx[0]("/kalmar"));
    			attr_dev(a3, "class", "svelte-35bq4m");
    			add_location(a3, file$q, 92, 8, 2321);
    			attr_dev(li3, "class", "uk-parent svelte-35bq4m");
    			add_location(li3, file$q, 91, 6, 2289);
    			attr_dev(a4, "href", a4_href_value = /*$url*/ ctx[0]("/stockholm"));
    			attr_dev(a4, "class", "svelte-35bq4m");
    			add_location(a4, file$q, 95, 8, 2410);
    			attr_dev(li4, "class", "uk-parent svelte-35bq4m");
    			add_location(li4, file$q, 94, 6, 2378);
    			attr_dev(ul, "class", "uk-navbar-nav");
    			add_location(ul, file$q, 81, 4, 1989);
    			attr_dev(div0, "class", "uk-navbar-center svelte-35bq4m");
    			add_location(div0, file$q, 80, 2, 1953);
    			attr_dev(nav, "class", "uk-navbar-container svelte-35bq4m");
    			attr_dev(nav, "uk-nav", "");
    			add_location(nav, file$q, 79, 0, 1909);
    			attr_dev(h30, "class", "uk-card-title uk-margin-remove-bottom");
    			add_location(h30, file$q, 107, 10, 2758);
    			attr_dev(div1, "class", "uk-width-expand");
    			add_location(div1, file$q, 106, 8, 2717);
    			attr_dev(div2, "class", "uk-grid-small uk-flex-middle");
    			attr_dev(div2, "uk-grid", "");
    			add_location(div2, file$q, 105, 6, 2657);
    			attr_dev(div3, "class", "uk-card-header");
    			add_location(div3, file$q, 104, 4, 2621);
    			add_location(p0, file$q, 114, 6, 2940);
    			attr_dev(div4, "class", "uk-card-body");
    			add_location(div4, file$q, 113, 4, 2906);
    			attr_dev(div5, "class", "uk-card skane-title uk-card-default uk-child-width-1 uk-grid-match svelte-35bq4m");
    			add_location(div5, file$q, 102, 2, 2530);
    			...
    			add_location(div11, file$q, 101, 0, 2498);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$r = "src\\pages\\stockholm.svelte";
    ...
    function create_fragment$G(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file$r, 67, 8, 1604);
    			attr_dev(li0, "class", "uk-parent svelte-1qvnqpl");
    			add_location(li0, file$r, 66, 6, 1572);
    			attr_dev(a1, "href", a1_href_value = /*$url*/ ctx[0]("/skane"));
    			attr_dev(a1, "class", "svelte-1qvnqpl");
    			add_location(a1, file$r, 70, 8, 1690);
    			attr_dev(li1, "class", "uk-parent svelte-1qvnqpl");
    			add_location(li1, file$r, 69, 6, 1658);
    			attr_dev(a2, "href", a2_href_value = /*$url*/ ctx[0]("/blekinge"));
    			attr_dev(a2, "class", "svelte-1qvnqpl");
    			add_location(a2, file$r, 73, 8, 1777);
    			attr_dev(li2, "class", "uk-parent svelte-1qvnqpl");
    			add_location(li2, file$r, 72, 6, 1745);
    			attr_dev(a3, "href", a3_href_value = /*$url*/ ctx[0]("/kalmar"));
    			attr_dev(a3, "class", "svelte-1qvnqpl");
    			add_location(a3, file$r, 76, 8, 1870);
    			attr_dev(li3, "class", "uk-parent svelte-1qvnqpl");
    			add_location(li3, file$r, 75, 6, 1838);
    			attr_dev(a4, "href", a4_href_value = /*$url*/ ctx[0]("/stockholm"));
    			attr_dev(a4, "class", "svelte-1qvnqpl");
    			add_location(a4, file$r, 79, 8, 1959);
    			attr_dev(li4, "class", "uk-parent svelte-1qvnqpl");
    			add_location(li4, file$r, 78, 6, 1927);
    			attr_dev(ul, "class", "uk-navbar-nav");
    			add_location(ul, file$r, 65, 4, 1538);
    			attr_dev(div0, "class", "uk-navbar-center svelte-1qvnqpl");
    			add_location(div0, file$r, 64, 2, 1502);
    			attr_dev(nav, "class", "uk-navbar-container svelte-1qvnqpl");
    			attr_dev(nav, "uk-nav", "");
    			add_location(nav, file$r, 63, 0, 1458);
    			attr_dev(h30, "class", "uk-card-title uk-margin-remove-bottom");
    			add_location(h30, file$r, 91, 10, 2292);
    			attr_dev(div1, "class", "uk-width-expand");
    			add_location(div1, file$r, 90, 8, 2251);
    			attr_dev(div2, "class", "uk-grid-small uk-flex-middle");
    			attr_dev(div2, "uk-grid", "");
    			add_location(div2, file$r, 89, 6, 2191);
    			attr_dev(div3, "class", "uk-card-header");
    			add_location(div3, file$r, 88, 4, 2155);
    			add_location(p0, file$r, 98, 6, 2493);
    			attr_dev(div4, "class", "uk-card-body");
    			add_location(div4, file$r, 97, 4, 2459);
    			attr_dev(div5, "class", "uk-card uk-card-default uk-child-width-1 uk-grid-match svelte-1qvnqpl");
    			add_location(div5, file$r, 87, 2, 2081);
    			...
    			add_location(div11, file$r, 85, 0, 2047);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
